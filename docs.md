...
![Αποτελέσματα του αλγορίθμου](./EL3.images/matlab_results.PNG "Αποτελέσματα του αλγορίθμου")
*Αποτελέσματα του αλγορίθμου*
...
![Κύκλωμα τελεστικού ενισχυτή με τις αρχικές τιμές (Spice)](./EL3.images/OP_before.PNG "Κύκλωμα τελεστικού ενισχυτή με τις αρχικές τιμές (Spice)")
