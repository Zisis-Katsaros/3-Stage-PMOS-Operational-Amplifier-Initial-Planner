...
![Κύκλωμα τελεστικού ενισχυτή με τις αρχικές τιμές (Spice)](./EL3.images/OP_before.PNG "Κύκλωμα τελεστικού ενισχυτή με τις αρχικές τιμές (Spice)")*Κύκλωμα τελεστικού ενισχυτή με τις αρχικές τιμές (Spice)*

Τρέχοντας μία AC analysis παρατηρείται ότι το περιθώριο φάσης είναι περίπου $80^{\circ}$.

![Γραφήματα μέτρου και φάσης κέρδους](./EL3.images/PM_before_graph.PNG "Γραφήματα μέτρου και φάσης κέρδους")
*Γραφήματα μέτρου και φάσης κέρδους*

![Τιμή φάσης όταν $|A|=0dB$](./EL3.images/PM_before_values.PNG "Τιμή φάσης όταν $|A|=0dB$")
...
![Κύκλωμα τελεστικού ενισχυτή με τις τελικές τιμές (Spice)](./EL3.images/OP_after.PNG "Κύκλωμα τελεστικού ενισχυτή με τις τελικές τιμές (Spice)")
...
![Γραφήματα μέτρου και φάσης κέρδους](./EL3.images/PM_after_graph.PNG "Γραφήματα μέτρου και φάσης κέρδους")
*Γραφήματα μέτρου και φάσης κέρδους*

![Τιμή φάσης όταν $|A|=0dB$](./EL3.images/PM_after_values.PNG "Τιμή φάσης όταν $|A|=0dB$")
*Τιμή φάσης όταν |A|=0dB*

![Slew Rate](./EL3.images/SR_after.PNG "Slew Rate")
*Slew Rate*
